...
abstract class CarouselController {
  ...
  factory CarouselController() => BasicCarouselController();
}

class BasicCarouselController implements CarouselController {
  ...
  void jumpToPage(int page) {
    ...
    return _state.pageController
        .jumpToPage(_state.pageController.page.toInt() + page - index);
  }
