...
/// This offset modulo our length, 6, will return a number between 0 and 5,
/// which represent the image to be placed in the given position.
int getRealIndex(int position, int base, int length) =>
    _remainder(position - base, length);

/// Returns the remainder of the modulo operation [input] % [source],
